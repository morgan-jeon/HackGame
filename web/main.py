...
def api(type: str):
    ...
    '울랄라 대장의 이메일은\ngshs_decode@gmail.com\n이야. 여기에 만든 파일을 보내자.\n답장이 왔다면 백도어가 작동하는지 확인해보자! 백도어는 msfconsole이라는 명령어로 실행할 수 있어! 도움말을 보자! "man msfconsole"',
    ...
    ['도움말을 읽어보고 무엇을 해야 할지 생각해 보자! 근데 페이로드는 뭐고, msfvenom은 뭐지..? "openvideo"로 영상을 보고 다음 단계로 넘어가자!','sys:run explorer http://sv.m03.pw:8000/video/p01.mp4'],
    ['이제 바탕화면에 EXE파일이 생성되었겠지?? 다음단계로 넘어가서 이 파일을 보내보자!'],
